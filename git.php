		...
		<main id="main_content">
			<article>
				...
				<section>
					<h3>Git</h3>
					<figure class="float">
						<img alt="GitHub commit" src="media/images/git_commit.png" />
				...
				<section>
					...
					<p>
						...
						Github ble opprettet i 2018 og har blitt veldig populært.
						Github har nylig (per <time datetime="2018-10-03">03.10.2018</time>) blitt kjøpt av Microsoft,
						så det er mulig at det vil bli noen forandringer.
					</p>
				</section>
				<section>
					<h3>konklusjon</h3>
